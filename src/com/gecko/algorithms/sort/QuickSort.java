...
public class QuickSort extends BaseSort{
	...
	public static <T> void sort(Comparable<T>[] comparables, int lo, int hi) {
	...
	// 
	public static <T> int partition(Comparable<T>[] comparables, int lo, int hi) {
		Comparable<T> p = comparables[lo];
		int i = lo, j = hi+1;
	...
	public static <T> String toString(Comparable<T>[] comparables) {
